define(['jquery', 'underscore', 'backbone.marionette', 'gsap.tweenlite', 'gsap.cssplugin', 'MarionetteTransition', 'animations/verticalSlideToPosition'], function($, _, Marionette, TweenLite, CSSPlugin, MarionetteTransition, verticalSlideToPosition) {
    'use strict';
