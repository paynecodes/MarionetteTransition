define(['jquery', 'underscore', 'backbone.marionette', 'TweenLite', 'CSSPlugin', 'MarionetteTransition', 'animations/opacity'], function($, _, Marionette, TweenLite, CSSPlugin, MarionetteTransition, opacity) {
    'use strict';
