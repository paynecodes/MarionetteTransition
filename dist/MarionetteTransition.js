...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define([], function (jQuery, _, Marionette, TweenLite, CSSPlugin) {
      return (root.returnExportsGlobal = factory(jQuery, _, Marionette, TweenLite, CSSPlugin));
    });
    ...
    root['MarionetteTransition'] = factory();
  }
...
var MarionetteTransition = function ($, _, Marionette, TweenLite, CSSPlugin, horizontalSlideToPosition) {
        ...
        var MarionetteTransition = Marionette.Region.extend({
                ...
                showTransition: function (view, options) {
                    ...
                    $.when(this.transition(view, oldView, showOptions)).then(_.bind(function () {
                        this._cleanUpOldViews();
                        this._resetViews(view);
                    }, this));
                ...
                closeTransition: function (options) {
                    ...
                    $.when(this.transition(null, view, closeOptions)).then(_.bind(onComplete, this));
                },
                ...
                transition: function (newView, oldView, options) {
                    ...
                    function transition() {
                        if (!newView) {
                            ...
                            dfds[0] = $.Deferred();
                            self.transitionIn(newView, options).done(function () {
                                dfds[0].resolve();
                            });
                        }
                        if (!oldView) {
                            ...
                            dfds[1] = $.Deferred();
                            self.transitionOut(oldView, options).done(function () {
                                dfds[1].resolve();
                            });
                        }
                        /*jshint validthis:true */
                        return $.when.apply($, dfds).done(_.bind(function () {
                ...
                transitionIn: function (view, options) {
                    ...
                    this.enterAnimation(view, options).eventCallback('onComplete', function () {
                        deferred.resolve();
                    }).play();
                    return deferred;
                },
                transitionOut: function (view, options) {
                    var deferred = $.Deferred();
                    this.exitAnimation(view, options).eventCallback('onComplete', function () {
                        deferred.resolve();
                    }).play();
                    return deferred;
                },
    ...
    }(jQuery, _, Marionette, TweenLite, CSSPlugin, animations_horizontalSlideToPosition);
